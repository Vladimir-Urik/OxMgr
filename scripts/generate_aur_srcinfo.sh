...
pkgbase = oxmgr-bin
	...
	source_x86_64 = https://github.com/${REPO}/releases/download/v${VERSION}/oxmgr-v${VERSION}-x86_64-unknown-linux-musl.tar.gz
	sha256sums_x86_64 = ${INTEL_SHA}
	source_aarch64 = https://github.com/${REPO}/releases/download/v${VERSION}/oxmgr-v${VERSION}-aarch64-unknown-linux-musl.tar.gz
